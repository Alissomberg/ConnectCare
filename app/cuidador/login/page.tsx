...
export default function CuidadorLoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Login cuidador:", formData)
    // Simulando login bem-sucedido
    router.push("/cuidador/feed")
  }
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto">
            ...
            <div className="bg-card p-8 rounded-3xl shadow-xl border border-border">
              ...
              <h1 className="text-3xl font-bold text-center mb-2 text-foreground">Login do Cuidador</h1>
              <p className="text-center text-muted-foreground mb-8">Entre para acessar sua conta profissional</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/cuidador/recuperar-senha" className="text-sm text-primary hover:underline font-semibold">
                    Esqueceu a senha?
                  </Link>
                </div>
